...
void print_list(const string& s, const list<type>& v) {
    cout << s << ": \n";
    for (type item : v) {
        cout << item << " ";
    }
...
void print(const string& s, const any& container) {
    cout << s << ": \n";
...
int main() {
   ...
   print("ilist sorted", ilist);
     ...
     * */
   // find_if is returning an iterator
   list<int>::iterator odd_iter1 = find_if(ilist.begin(), ilist.end(), 
        is_odd);
   cout << "First odd number in ilist is: " << *odd_iter1 << endl;
   odd_iter1++;
   cout << "Next odd number in ilist is: " << *odd_iter1 << endl;
   ...
   list<int>::iterator odd_iter2 = find_if(ilist.begin(), ilist.end(), 
        odd_functor);
   cout << "First odd number in ilist is: " << *odd_iter2 << endl;
   odd_iter2++;
   cout << "Next odd number in ilist is: " << *odd_iter2 << endl;
    /*
